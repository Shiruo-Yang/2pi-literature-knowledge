# Supplementary registry summary (v2.0)
...
| Domain knowledge | What should a two-photon radical photoinitiator be evaluated on? | `domain_knowledge_registry.csv` | 25 |
| Endpoints and representations | What is predicted and how is the molecule represented? | `endpoint_representation_registry.csv` | 37 |
| Mechanism decisions | How is a candidate assigned to Type-I, Type-II or SET/PET assessment? | `mechanism_decision_registry.csv` | 25 |
